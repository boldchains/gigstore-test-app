...
<h4 align="center">
TikTok like layout for this app
</h4>
...
- [VS Code][vc] with [EditorConfig][vceditconfig] and [ESLint][vceslint] and Jest
...
$ git clone https://github.com/james-lin71/gigstore-test-app
gigstore-test-app

# Go into the repository
$ cd gigstore-test-app
